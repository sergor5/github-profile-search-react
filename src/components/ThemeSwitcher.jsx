...
export const DarkModeSwitch = ({ onChange, children, checked = false, size = 24, animationProperties = defaultProperties, moonColor = 'white', sunColor = 'black', style, ...rest }) => {
  ...
  return (
    ...
    >
      ...
      <animated.circle cx="12" cy="12" fill={checked ? moonColor : sunColor} style={centerCircleProps} mask={`url(#${uniqueMaskId})`} />
